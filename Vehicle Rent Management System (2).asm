...
BIKE:
     ...
     mov byte ptr [vehicleName + eax], 0 ; add null terminator to end of string  by adding the value of eax (which contains the length of the string read) to the address of vehicleName.
 ...
 ; for reading and displaying data from a file related to bikes.
BikeReadLoop:
...
BikeSearch_loop:
     lodsb ; Load byte from string into AL and increment ESI
